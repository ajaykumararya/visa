                        ...
                        <div class="row marginFromBottom paddingAllExtra whiteBG borderFromTop mobpaddingInBox">
                                ...
                                <div class="row gapping how2BG">
                                    ...
                                    <div class="wrap paddingFromTop">
                                        <div class="container column-eight">
                                            <div class="stepDivBox"> <img src="<?=base_url()?>assets/website/images/st1.png" width=""
                                            ...
                                            <div class="stepDivBox"> <img src="<?=base_url()?>assets/website/images/st2.png" width=""
                                            ...
                                            <div class="stepDivBox"> <img src="<?=base_url()?>assets/website/images/st3.png" width=""
                                            ...
                                            <div class="stepDivBox"> <img src="<?=base_url()?>assets/website/images/st4.png" width=""
                            ...
                            <section class="row pageGapping paddingFromBottomNone" id="DR">
                                <div class="row reqBox marginFromBottom">
                                    <div class="column-two"><img src="<?=base_url()?>assets/website/images/document-icon.png" width="160"
                                    ...
                                    <div class="column-eight mobPaddingTop">
                                        ...
                                        <div class="row line-height-reg padding-All-sm font16"><img
                                                src="<?=base_url()?>assets/website/images/plus.png" class="marginFromRight" alt="Passport"
                                                title="Passport" /> <strong>Passport</strong>: A clear copy of your
                                            valid passport with at least 6 months remaining validity.</div>
                                        <div class="row line-height-reg padding-All-sm font16"><img
                                                src="<?=base_url()?>assets/website/images/plus.png" class="marginFromRight" alt="Photograph"
                            ...
                            <section class="row pageGapping paddingFromBottomNone" id="QF">
                                <div class="row borderFromAll paddingAllExtra mobmarginBtm30">
                                    <div class="column-three"><img src="<?=base_url()?>assets/website/images/qf.png" class="container"
