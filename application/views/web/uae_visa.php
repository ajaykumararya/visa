...
<div class="row marginFromTop mobImgfull-width"><img class="lazy" data-src="<?=base_url()?>assets/website/media/images/contact.webp"></div>
    <div class="row content">
        <div class="wrap gapping">
            ...
            <p>1. Mention your nationality and the country from which you are traveling.
                ...
                for different types of visas that suit your preference at Tourist Dubai Visa.&nbsp;
            </p>
    ...
    <div class="wrap gapping">
        ...
        <div class="accordion_container">
            <div class="row"> <a href="#" class="accordion_head submenuheader" headerindex="0h"><span
                    ...
                    the UAE?<span class="accordsuffix"><img src="<?=base_url()?>assets/website/media/images/plus.png"
                            alt="Expand" class="statusicon"></span><span class="accordsuffix"><img
                            src="<?=base_url()?>assets/website/media/images/plus.png" alt="Expand"
            ...
            <div class="row"> <a href="#" class="accordion_head submenuheader" headerindex="1h"><span
                        ...
                        class="accordsuffix"><img src="<?=base_url()?>assets/website/media/images/plus.png" alt="Expand"
            ...
            <div class="row"> <a href="#" class="accordion_head submenuheader" headerindex="4h"><span
                    ...
                    UAE visa? <span class="accordsuffix"><img src="<?=base_url()?>assets/website/media/images/plus.png"
                            alt="Expand" class="statusicon"></span><span class="accordsuffix"><img
                            src="<?=base_url()?>assets/website/media/images/plus.png" alt="Expand"
                            class="statusicon"></span></a>
            ...
            <div class="row"> <a href="#" class="accordion_head submenuheader" headerindex="5h"><span
                    ...
                    in UAE?<span class="accordsuffix"><img src="<?=base_url()?>assets/website/media/images/plus.png"
                            alt="Expand" class="statusicon"></span><span class="accordsuffix"><img
                            src="<?=base_url()?>assets/website/media/images/plus.png" alt="Expand"
                            class="statusicon"></span></a>
            ...
            <div class="row"> <a href="#" class="accordion_head submenuheader" headerindex="7h"><span
                    ...
                    visa?<span class="accordsuffix"><img src="<?=base_url()?>assets/website/media/images/plus.png"
                            alt="Expand" class="statusicon"></span><span class="accordsuffix"><img
                            src="<?=base_url()?>assets/website/media/images/plus.png" alt="Expand"
                            class="statusicon"></span></a>
