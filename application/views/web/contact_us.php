    ...
    <section class="row">
        ...
        <div class="column-eight container">
            ...
            <div class="row alignFromCenter marginFromBottom line-height-reg">
                ...
                <div class="row alignLeft label paddingAllExtra marginFromTop border-Dashed marginFromBottom greyBG"
                    style="box-shadow:3px 3px 3px #ccc">
                    <h3 class="row green marginFromBottom line-height-reg">Ways to Connect with Us:</h3>
                    <div class="row borderFromBottom">
                        <div class="column-two">Email ID</div>
                ...
                <div class="row marginFromTop">
                    <div class="column-four container box_Sizing mobpadding-0 ipadimg">
                        <div class="row paddingAll greenBG white alignLeft marginFromBottom">
                            <h3 class="row marginFromBottom borderFromBottom paddingFromBottom font-Weight-Normal">
                                Registered Office</h3>
                            <h4 class="row">Proglogix International Services Pvt Ltd</h4>
                            <div class="row">SS BC F 104, JABAL ALI INDUSTRIAL FIRST P.O. BOX:46777 DUBAI, UNITED ARAB EMIRATES</div>
                            <div class="row">Contact - +91-971589667714</div>
                        </div>
                    </div>
                    <div class="column-six  paddingFromLeft box_Sizing mobpadding-0"></div>
                </div>
            </div>
        </div>
    </section>
